...
const v12 = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: `<ol><li><strong>발효 텐션</strong> — 56분 종료 시 손가락 눌림이 9차 사진과 가장 가깝. 11차 58분보다 팽팽</li><li><strong>다음 날 겉·속</strong> — 10·11차 바로 백과 유사. 겉 건조 심하지 않음, 속 촉촉함 유지</li><li><strong>향·밀착</strong> — 8~11차 수준. 분을 줄였다고 토핑이 뜨거나 향이 죽진 않음</li></ol><p>가족은 '지난번(11차)보다 속이 더 고르다'고 했습니다. 제 기준으로 <strong>12차는 부분 성공</strong> — 습도 42%대 보정 분으로 56분을 1차 확정 후보에 올렸습니다. 55분 단일 확인은 아직 안 했습니다.</p>${fig(slug, "failures", "실패 1~3 — 눈에 보인 현상")}<p>당일 오븐 색은 11차와 비슷했습니다. 차이는 성형 직전 반죽 텐션과, 다음 날 단면을 나란히 둘 때 기공 균일감에서 조금 보였습니다.</p><p>과발효 느낌(상단이 무너지거나 시큼함)은 없었습니다. 11차 58분이 '조금 여유'였다면, 12차 56분은 '9차와 비슷한 지점'에 가깝습니다.</p><p>다음 날 아침 단면 사진을 11차와 나란히 두었습니다. 기공 크기의 들쭉날쭉함이 12차에서 조금 줄어 보였고, 그 차이를 가족 표현('고르다')과 맞춰 메모에 남겼습니다.</p>`
    },
    {
      id: "cause",
      heading: "h2",
